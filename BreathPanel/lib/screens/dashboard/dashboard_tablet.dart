...
class DashboardTabletPortrait extends StatefulWidget {
  ...
  DashboardTabletPortrait({this.device,});
  @override
            ...
            builder: (context, snapshot) {
              return StaggeredGridView.count( 
                ...
                children: <Widget>[
                  ...
                  card.Card(Column(mainAxisAlignment:  MainAxisAlignment.center,children:[ Text("${bloc.porc_oxi}",style: TextStyle(fontSize: 45))]),"Porcentagem de Oxigênio",80,true,13),
                  card.Card(Column(mainAxisAlignment:  MainAxisAlignment.center,children:[ Text("${bloc.porc_pausa}%",style: TextStyle(fontSize: 45))]), "Porcentagem de Pausa",80,true,13),
                  card.Card(Column(mainAxisAlignment:  MainAxisAlignment.center,children:[ Text("${bloc.volume_tidal}",style: TextStyle(fontSize: 45))]), "Volume Tidal",80,true,13),
                  card.Card(Column(mainAxisAlignment:  MainAxisAlignment.center,children:[ Text("${bloc.frequencia}",style: TextStyle(fontSize: 45))]), "Frequência",80,true,13),
                  card.Card(Column(mainAxisAlignment:  MainAxisAlignment.center,children:[ Text("${bloc.pressao_max}",style: TextStyle(fontSize: 45))]), "Pressão máxima",80,true,13),
                  card.Card(Column(mainAxisAlignment:  MainAxisAlignment.center,children:[ Text("${bloc.temp_insp}",style: TextStyle(fontSize: 45))]), "Tempo Inspiratório(s)",80,true,13 ),
...
class DashboardTabletLandscape extends StatefulWidget {
  final UsbDevice device;
  DashboardTabletLandscape({this.device,});
  @override
