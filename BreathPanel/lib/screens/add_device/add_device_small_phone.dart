...
class AddDeviceSmallPhonePortrait extends StatefulWidget {
  ...
  @override
  _AddDeviceSmallPhonePortraitState createState() => _AddDeviceSmallPhonePortraitState();
}

class _AddDeviceSmallPhonePortraitState extends State<AddDeviceSmallPhonePortrait> {
                        ...
                        children: <Widget>[
                          Container(
                            child: Column(children: [
                              Text("BreathPanel",style: TextStyle(color: Theme.of(context).primaryColor,fontSize: 30,fontWeight: FontWeight.bold)),
                              Image(width: 180, height: 180,image: AssetImage("Assets/icon.png"),),
                              Text("InjeVent",style: TextStyle(color: Theme.of(context).primaryColor,fontSize: 25,fontWeight: FontWeight.bold)),
                            ],),
                          ),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                    children: [
                                      Text("Portas seriais disponíveis:",style:TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold)),
                                      ...bloc.ports,
                                      Text("Status: ${bloc.status}",style:TextStyle(color: Colors.white,fontSize: 17,fontWeight: FontWeight.bold)),
...
class AddDeviceSmallPhoneLandscape extends StatefulWidget {
  ...
  @override
  _AddDeviceSmallPhoneLandscapeState createState() => _AddDeviceSmallPhoneLandscapeState();
}

class _AddDeviceSmallPhoneLandscapeState extends State<AddDeviceSmallPhoneLandscape> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  @override
  void initState() {
    super.initState();
                          ...
                          builder: (context, snapshot) {
                            return Column(
                              ...
                              children: <Widget>[
                                ...
                                RaisedButton(
                                child: Text("Ir para o painel",style:TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.white)),
