...
class AddDeviceMobilePortrait extends StatefulWidget {
  ...
  @override
  _AddDeviceMobilePortraitState createState() => _AddDeviceMobilePortraitState();
}
                        ...
                        children: <Widget>[
                          Container(
                            child: Column(children: [
                              Text("BreathPanel",style: TextStyle(color: Theme.of(context).primaryColor,fontSize: 40,fontWeight: FontWeight.bold)),
                              Image(width: 200, height: 200,image: AssetImage("Assets/icon.png"),),
...
class AddDeviceMobileLandscape extends StatefulWidget {
  ...
  @override
  _AddDeviceMobileLandscapeState createState() => _AddDeviceMobileLandscapeState();
}
